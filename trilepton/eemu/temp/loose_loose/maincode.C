...
void maincode(){
  ...
  TH1D *hist_HN_plus = new TH1D("hist_HN_plus", "#mue#nu_plus", 400./5. ,0., 400.);
  TH1D *hist_HN_minus = new TH1D("hist_HN_minus", "#mue#nu_plus", 400./5. ,0., 400.);
  TH1D *hist_HN_inverse_plus = new TH1D("hist_HN_inverse_plus", "#mue#nu_inverse_plus", 400./5. ,0., 400.);
  TH1D *hist_HN_inverse_minus = new TH1D("hist_HN_inverse_minus", "#mue#nu_inverse_plus", 400./5. ,0., 400.);
  TH1D *hist_W_real_plus = new TH1D("hist_W_real_plus", "e#mue#nu_plus", 400./5. ,0., 400.);
  TH1D *hist_W_real_minus = new TH1D("hist_W_real_minus", "e#mue#nu_minus", 400./5. ,0., 400.);
