...
#include "/home/jskim/Documents/CMS/header/Electron.h"
...
void chi2_lambda_stack_eee(){
  ...
  TString savepath = "/home/jskim/Documents/CMS/trilepton/eee/plots/";
  bool selection;
  TChain *chain_el[N_chain], *chain_event[N_chain], *chain_jet[N_chain];
  ...
  chain_el[0]->Add("./files/signal/trilepton_eee_SKHN"+TString::Itoa(sample, 10)+"_eee_new_5_3_14.root");
  chain_event[0]->Add("./files/signal/trilepton_eee_SKHN"+TString::Itoa(sample, 10)+"_eee_new_5_3_14.root");
  chain_jet[0]->Add("./files/signal/trilepton_eee_SKHN"+TString::Itoa(sample, 10)+"_eee_new_5_3_14.root");
  ...
  for(int i=2; i<N_chain; i++){
    ...
    chain_el[i]->Add("./files/bkg/trilepton_eee_SK"+chainlist[i]+"_5_3_14.root");
    chain_event[i]->Add("./files/bkg/trilepton_eee_SK"+chainlist[i]+"_5_3_14.root");
    chain_jet[i]->Add("./files/bkg/trilepton_eee_SK"+chainlist[i]+"_5_3_14.root");
  }
  ...
  for(int l=0; l<N_chain; l++){
    ...
    el[k] = new Electron(chain_el[k], 3);
    ...
    for(int i=0; i<chain_el[k]->GetEntries(); i++){
      
      printeventnumber(i, chain_el[k]->GetEntries());
      ...
      for(int j=0; j<3; j++){ // lepton 4-vec
        lep[j].SetPxPyPzE(el[k]->Px[j],el[k]->Py[j],el[k]->Pz[j],el[k]->E[j]);
      }
      
      //Cut : Three HNLoose//
      selection = el[k]->isMySel(0, 15) && el[k]->isMySel(1, 10) && el[k]->isMySel(2, 10);
      //Cut : dR > 0.5//
  ...
  lg1->AddEntry(hist_HN[0], "HN"+TString::Itoa(sample, 10)+", |V_{Ne}|^{2}=10^{"+TString::Itoa(TMath::Log10(coupling_const), 10)+"}", "l");
  //y=0//
  double x_0[2], y_0[2];
  x_0[0] = -1000;  y_0[0] = 0;
  x_0[1] = 1000;  y_0[1] = 0;
  ...
  hist_HN_diff->GetXaxis()->SetTitle("m(e_{2}e_{3}#nu) [GeV]");
  ...
  hist_W_real_diff->GetXaxis()->SetTitle("m(e_{1}e_{2}e_{3}#nu) [GeV]");
  ...
  hist_gamma_star_diff->GetXaxis()->SetTitle("m(e+e-) for Minimum #DeltaR [GeV]");
  ...
  hist_z_candidate_diff->GetXaxis()->SetTitle("m(e+e-) for Z-candidate [GeV]");
...
void chi2_lambda_stack_eee(int sample, int isPU, int additional_cut, int elidsel_int){ // elidsel = 0 = loose, elidsel = 1 = tight
  ...
  double HN_x_min, HN_x_max, HN_dx, W_real_x_min, W_real_x_max, W_real_dx, dR_x_min, dR_x_max, dR_dx, gamma_star_x_min, gamma_star_x_max, gamma_star_dx, z_candidate_x_min, z_candidate_x_max, z_candidate_dx;
  TString savepath = "/home/jskim/Documents/CMS/trilepton/eee/plots/", elidsel;
  bool selection;
  TChain *chain_el[N_chain], *chain_event[N_chain], *chain_jet[N_chain];
  /*
   cout
  ...
  if(elidsel_int == 0)  elidsel = "loose";
  if(elidsel_int == 1)  elidsel = "tight";
  ...
  if(additional_cut==0){
    ...
    gamma_star_x_min=0, gamma_star_x_max=120, gamma_star_dx=1; y_max[3] = 600;
    z_candidate_x_min=0, z_candidate_x_max=120, z_candidate_dx=1; y_max[4] = 600;
    if(elidsel == "loose")  savepath += "before_dR/loose_";
    if(elidsel == "tight")  savepath += "before_dR/tight_";
    ischi2 = 0;
  }
  if(additional_cut==1){
    HN_x_min=0; HN_x_max=500; HN_dx=10; y_max[0] = 350;
    ...
    gamma_star_x_min=0, gamma_star_x_max=120, gamma_star_dx=1; y_max[3] = 200;
    z_candidate_x_min=0, z_candidate_x_max=120, z_candidate_dx=1;y_max[4] = 600;
    if(elidsel == "loose")  savepath += "dR/loose_";
    if(elidsel == "tight")  savepath += "dR/tight_";
    ischi2 = 0;
  }
  if(additional_cut==2){
    HN_x_min=0; HN_x_max=100; HN_dx=10; y_max[0] = 100;
    ...
    gamma_star_x_min=0, gamma_star_x_max=120, gamma_star_dx=5; y_max[3] = 60;
    z_candidate_x_min=0, z_candidate_x_max=120, z_candidate_dx=5; y_max[4] = 60;
    if(elidsel == "loose")  savepath += "dR_W/loose_";
    if(elidsel == "tight")  savepath += "dR_W/tight_";
    ischi2 = 0;
  }
  if(additional_cut==3){
    HN_x_min=0; HN_x_max=100; HN_dx=10; y_max[0] = 70;
    ...
    gamma_star_x_min=0, gamma_star_x_max=120, gamma_star_dx=5; y_max[3] = 40;
    z_candidate_x_min=0, z_candidate_x_max=120, z_candidate_dx=5; y_max[4] = 40;
    if(elidsel == "loose")  savepath += "dR_chi2/loose_";
    if(elidsel == "tight")  savepath += "dR_chi2/tight_";
    ischi2 = 1;
  }
  if(additional_cut==4){
    HN_x_min=0; HN_x_max=100; HN_dx=10; y_max[0] = 70;
    ...
    gamma_star_x_min=0, gamma_star_x_max=120, gamma_star_dx=5; y_max[3] = 40;
    z_candidate_x_min=0, z_candidate_x_max=120, z_candidate_dx=5; y_max[4] = 40;
    if(elidsel == "loose")  savepath += "dR_chi2_lambda/loose_";
    if(elidsel == "tight")  savepath += "dR_chi2_lambda/tight_";
    ischi2 = 1;
  }
  ...
  for(int l=0; l<N_chain; l++){
    ...
    for(int i=0; i<chain_el[k]->GetEntries(); i++){
      ...
      //Cut : Three HNLoose//
      if(elidsel == "loose")  selection = el[k]->isMySel(0, 15) && el[k]->isMySel(1, 10) && el[k]->isMySel(2, 10);
      if(elidsel == "tight")  selection = el[k]->isMySel(0, 15) && el[k]->isMySel(1, 10) && el[k]->isMySel(2, 10);
      //Cut : dR > 0.5//
      if(additional_cut == 1 || additional_cut == 2 || additional_cut == 3 || additional_cut == 4){
        selection *= TMath::Min( lep[0].DeltaR(lep[1]) , lep[2].DeltaR(lep[1]) ) > 0.5;
      }
