...
void control_check_eee(){
  ...
  TString savepath = "/home/jskim/Documents/CMS/trilepton/eee/plots/control/", elidsel="loose";
  bool selection;
  ...
  lg1->AddEntry(hist_met[0], "HN"+TString::Itoa(sample, 10)+", |V_{N}|^{2}=10^{"+TString::Itoa(TMath::Log10(coupling_const), 10)+"}", "l");
  //y=0//
  double x_0[2], y_0[2];
  x_0[0] = -1000;  y_0[0] = 0;
  x_0[1] = 1000;  y_0[1] = 0;
...
void control_check_eee(int sample, int isPU, int additional_cut, int elidsel_int){ // elidsel = 0 = loose, elidsel = 1 = tight
  ...
  double met_x_min, met_x_max, met_dx, lead_pt_x_min, lead_pt_x_max, lead_pt_dx, lead_eta_x_min, lead_eta_x_max, lead_eta_dx, n_jets_x_min, n_jets_x_max, n_jets_dx, n_bjets_x_min, n_bjets_x_max, n_bjets_dx;
  TString savepath = "/home/jskim/Documents/CMS/trilepton/eee/plots/control/", elidsel;
  bool selection;
  TChain *chain_el[N_chain], *chain_event[N_chain], *chain_jet[N_chain];
  /*
   cout
  ...
  if(additional_cut==5){
    ...
    n_jets_x_min=0; n_jets_x_max=10; n_jets_dx=1; y_max[3]=1500;
    n_bjets_x_min=0; n_bjets_x_max=5; n_bjets_dx=1; y_max[4]=3000;
    if(elidsel == "loose")  savepath += "dR_nbjets/loose_";
    if(elidsel == "tight")  savepath += "dR_nbjets/tight_";
    ischi2 = 0;
  }
  ...
  lg1->AddEntry(hist_met[22], "Higgs", "f");
  lg1->AddEntry(hist_met[14], "others", "f");
  lg1->AddEntry(hist_met[0], "HN"+TString::Itoa(sample, 10)+", |V_{Ne}|^{2}=10^{"+TString::Itoa(TMath::Log10(coupling_const), 10)+"}", "l");
  //y=0//
  double x_0[2], y_0[2];
  x_0[0] = -1000;  y_0[0] = 0;
  x_0[1] = 1000;  y_0[1] = 0;
